...
const buildProcurementsCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Purchase Orders',
...
export function createProcurementsCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildProcurementsCrudOpenApi(options)
}
